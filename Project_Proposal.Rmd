...
* How genres contribute to the ROI(Return on Investment)
* Which movies had a wide reach in terms of the languages in which they were released
* How has the industry performed in terms of number of movies over the years 
* How is the distribution of movies with repect to ratings, vote counts and several other factors present in the dataset
* Are there unicorn production companies that have better track record in terms of producing more successful movies
* Does the success of the movie depend on the month of release in different countries? It would be good to see if we can find any pattern.
